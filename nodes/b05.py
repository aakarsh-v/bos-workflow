...
def b05(state: AgentState):
    ...
    # Factor A: Farmer Meetings
    # Formula: MIN(PL_Active_Last_Q * 0.25, 6)
    ...
    # Factor B: New Onboarding
    # Formula: MAX(1, Total_DCs * 0.02)
    ...
    state.setdefault("bo_results", {})["BO5"] = {
        "ratio": final_ratio,
        "meeting_ratio": ratio_meet,
        "onboarding_ratio": ratio_new
    }
    return state