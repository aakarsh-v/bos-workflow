...
def b04(state: AgentState):
    ...
    # Factor A: Velocity
    # Formula: Sales_MTD / (Last_Month_Sales * 1.15)
    ...
    ratio_vel = min(ratio_vel, 1.5) # Cap

    # Factor B: Spread
    # Formula: Unique_Transacting / MIN(Total_DCs * 0.6, Last_Month_Active * 1.2)
    ...
    state.setdefault("bo_results", {})["BO4"] = {
        "ratio": final_ratio,
        "velocity": ratio_vel,
        "spread": ratio_spread
    }
